    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_logged_in', models.DateTimeField(default=datetime.datetime(2018, 1, 1, 0, 0, tzinfo=utc), verbose_name='Last Logged in')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, verbose_name='Name')),
                ('size', models.DecimalField(blank=True, decimal_places=3, max_digits=25, null=True, verbose_name='Size')),
                ('type', models.CharField(choices=[('bottle', 'Bottle'), ('cap', 'Cap'), ('other', 'Container')], default='bottle', max_length=255, verbose_name='Container Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, max_length=256, storage=django.core.files.storage.FileSystemStorage(), upload_to='')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intake_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Intake Recipient')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('accept', 'Accept'), ('hold', 'Hold'), ('reject', 'Reject')], default='accept', max_length=25, verbose_name='Status')),
                ('quantity', models.DecimalField(decimal_places=3, max_digits=25, verbose_name='Quantity')),
                ('goods_intake', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredients', to='main.GoodsIntake', verbose_name='Goods Intake')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, verbose_name='Name')),
                ('unit', models.CharField(choices=[('kilogram', 'kg'), ('litre', 'litre')], help_text='Ingredient is measured in?', max_length=25, verbose_name='Units')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.Company', verbose_name='Company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_bottling', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Date of Bottling')),
                ('date_of_best_before', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Date of Best Before')),
                ('yield_quantity', models.DecimalField(decimal_places=3, max_digits=25, verbose_name='Yield Quantity (in litres)')),
                ('batch_code', models.CharField(max_length=25, verbose_name='Batch Code')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='2 or 3 letter code for batch code creation', max_length=3, verbose_name='Code')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.Company', verbose_name='Company')),
                ('ingredient_types', models.ManyToManyField(related_name='product_types', to='main.IngredientType', verbose_name='Ingredients')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.DecimalField(decimal_places=3, max_digits=25, verbose_name='Quantity')),
                ('container', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='yield_containers', to='main.Container')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='yield_containers', to='main.Product', verbose_name='Product')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='product',
            name='product_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='main.ProductType', verbose_name='Product'),
        ),
        migrations.AddField(
            model_name='ingredient',
            name='ingredient_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredients', to='main.IngredientType', verbose_name='Ingredient Type'),
        ),
        migrations.AddField(
            model_name='ingredient',
            name='supplier',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ingredients', to='main.Supplier', verbose_name='Supplier'),
        ),
        migrations.AddField(
            model_name='document',
            name='author',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='documents', to=settings.AUTH_USER_MODEL, verbose_name='Author'),
        ),
        migrations.AddField(
            model_name='document',
            name='focus',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='focused_documents', to=settings.AUTH_USER_MODEL, verbose_name='Associated with'),
        ),
        migrations.AddField(
            model_name='document',
            name='goods_intake',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='documents', to='main.GoodsIntake', verbose_name='Intake of Goods'),
        ),
        migrations.AddField(
            model_name='document',
            name='supplier',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='documents', to='main.Supplier', verbose_name='Linked Supplier'),
        ),
        migrations.AddField(
            model_name='container',
            name='container_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.ContainerType', verbose_name='Container'),
        ),
        migrations.AddField(
            model_name='container',
            name='goods_intake',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='containers', to='main.GoodsIntake', verbose_name='Goods Intake'),
        ),
        migrations.AddField(
            model_name='container',
            name='supplier',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='containers', to='main.Supplier', verbose_name='Supplier'),
        ),
        migrations.AddField(
            model_name='area',
            name='company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.Company', verbose_name='Company'),
        ),
        migrations.AddField(
            model_name='user',
            name='company',
        ...
        migrations.AddField(
            ...
            name='breakage_area',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.Area'),
        ),
        migrations.AddField(
