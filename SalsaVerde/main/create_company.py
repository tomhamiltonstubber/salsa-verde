...
from SalsaVerde.main.models import (User, ContainerType, Container, Supplier, IngredientType, Ingredient, ProductType,
                                    Product, ProductIngredient, YieldContainer, GoodsIntake, Company)
...
def create_full_company(company=None):
    ...
    user = User.objects.create_user(email='owner@salsaverde.com', first_name='Bruce', last_name='Banner',
                                    password='testing', company=company)
    ...
    supplier_1 = Supplier.objects.create(
        ...
        postcode='BT62 H90', email='green_food@example.com', main_contact='Beatrice', company=company
    )
    supplier_2 = Supplier.objects.create(
        ...
        email='modena_balsamic@example.com', main_contact='Mario', company=company)
