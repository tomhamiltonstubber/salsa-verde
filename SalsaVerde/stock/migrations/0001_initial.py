...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'product',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to='stock.Product', verbose_name='Product'
                    ),
                ),
            ],
            options={'abstract': False,},
        ...
        migrations.AddField(
            ...
            name='container_type',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='stock.ContainerType', verbose_name='Container'
            ),
        ),
        migrations.AddField(
            model_name='container',
        ...
        migrations.AddField(
            model_name='glassaudit',
            name='container',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stock.Container'),
        ),
        migrations.AddField(
            model_name='complaint',
            name='affected_product',
            field=models.ManyToManyField(related_name='complaints', to='stock.Product'),
        ),
        migrations.AddField(
            model_name='complaint',
            name='investigator',
